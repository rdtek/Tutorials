...
'(32 bit) C:\Windows\SysWOW64\wscript.exe COMClient.vbs
'(64 bit) C:\Windows\System32\wscript.exe COMClient.vbs
 
dim objTest, intResult
Set objTest = WScript.CreateObject("COMServer.ComClassExample")
